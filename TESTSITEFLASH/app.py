...
def main():
        if request.method=='POST':
            ...
            def transfo(i, yourhash, ratio):
                ...
                DICO[
                    NAME1] = ACRONYME1  # https://www.delftstack.com/fr/howto/python/dictionary-with-multiple-values-in-python/
                ...
                for z in range(1, 6):
                    ...
                    for i in range(1, nb_max):
                        try:
                            ...
                            PRICE1 = browser.find_element(By.XPATH,
                                                          '//*[@id="coins"]/tbody/tr[{}]/td[6]/span'.format(i))
                            NETWORKHASH1 = browser.find_element(By.XPATH,
