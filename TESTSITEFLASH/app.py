...
def main():
        ...
        if request.method=='POST':
            ...
            def tout(nb_max, yourhash):
                # chaine a completer
                chaine = ['Etchash', 'Ethash', 'KawPow', 'Equihash 125,4', 'RandomX', 'Lyra2REv2', 'Skein','Autolykos 2','Eaglesong', 'kHeavyHash', 'Octopus', 'Cuckoo Cycle', 'ProgPow', 'FiroPoW', 'BeamHash','Equihash 210,9','NexaPow','SHA256DT','Blake3','HeavyHash','GhostRider']
